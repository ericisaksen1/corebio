...
export function CtaBanner({ heading, subtext, buttonText, buttonUrl, style, bgColor, headlineColor, textColor, buttonColor, buttonHoverColor }: CtaBannerProps) {
  return (
    <section className={`${styleClasses[style] || styleClasses.primary}`} style={sectionColorStyle({ bgColor, buttonColor, buttonHoverColor })}>
