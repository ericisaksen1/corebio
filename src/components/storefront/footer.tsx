...
function Copyright({ storeName }: { storeName: string }) {
  return (
...
export async function Footer() {
  const [footerMenuItems, settings, session] = await Promise.all([
    getMenuItems("footer"),
    getSettings(["store_name", "footer_layout", "site_logo_url", "logo_height", "enable_affiliates"]),
    auth(),
  ])
