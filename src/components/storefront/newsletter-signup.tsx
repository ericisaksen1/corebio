...
export function NewsletterSignup({ heading, description, buttonText, placeholder, bgColor, headlineColor, textColor, buttonColor, buttonHoverColor }: NewsletterSignupProps) {
  ...
  return (
    <section className="bg-[#f5f5f7]" style={sectionColorStyle({ bgColor, buttonColor, buttonHoverColor })}>
