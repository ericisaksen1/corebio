...
export function CountdownTimer({ heading, endDate, buttonText, buttonUrl, expiredMessage, bgColor, headlineColor, textColor, buttonColor, buttonHoverColor }: CountdownTimerProps) {
  ...
  return (
    <section className="bg-gray-900 text-white" style={sectionColorStyle({ bgColor, buttonColor, buttonHoverColor })}>
