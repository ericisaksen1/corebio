...
export function CheckoutForm({ cartItems, subtotal, affiliateRef, shippingRate, taxRate }: CheckoutFormProps) {
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
      ...
      <div className="lg:col-span-3">
        <form action={handleSubmit} className="space-y-8">
          ...
          <Button type="submit" size="lg" className="w-full" disabled={loading || !selectedPayment}>
      ...
      <div className="lg:col-span-2">
        <div className="sticky rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800" style={{ top: "calc(var(--header-height, 64px) + 1rem)" }}>
